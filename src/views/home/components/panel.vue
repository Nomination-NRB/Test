      ...
      <el-tab-pane label="基本操作" name="basic" class="el-tabs__content">
        <el-scrollbar noresize height="560px">
          <div style="width: 98%">
            ...
            <el-button type="primary" style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
              应用
      ...
      <el-tab-pane label="灰度变换" name="change" class="el-tabs__content">
        <el-scrollbar noresize height="560px">
          <div style="width: 98%">
            ...
            <el-divider content-position="center" style="font-size: 20px">直方图规定化</el-divider>
            <el-button type="primary" style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
